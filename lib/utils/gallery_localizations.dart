...
class GalleryLocalizations {
  ...
  String get starterLoginLoginToStarter {
    return Intl.message('Emailer',
        locale: _localeName,
        name: 'starterLoginLoginToStarter',
        desc:
        r'Title for login page for the Starter app (Starter does not need to be translated as it is a product name).');
  }

  String get starterGoogleSigninButton {
    return Intl.message('Sign in with Google',
        locale: _localeName,
        name: 'starterGoogleSigninButton',
        desc: r'Text for Google sign in button.');
  }
